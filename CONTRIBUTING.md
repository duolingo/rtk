...
RTK uses [Conventional Commits](https://www.conventionalcommits.org/) for change descriptions. If automated releases are enabled for this fork, those messages may be used to generate CHANGELOG entries and release notes. Do not edit `CHANGELOG.md` manually unless maintainers ask you to.
...
Write commit messages as if they will be read by users in release notes.
...
Use a conventional branch name such as `feat/scope-your-clear-description`, `fix/scope-your-clear-description`, or `chore/scope-your-clear-description`.
...
This fork does not document a standalone CLA requirement. If contribution terms change, maintainers should add the applicable policy here before requiring it from contributors.

### 5. Open a Pull Request

Once your work is ready, open a Pull Request against this fork's mainline branch.
...
Once merged, your changes are tested by CI and released according to this fork's release process.
...
> **Note**: Do NOT edit `CHANGELOG.md` manually unless maintainers ask you to. See [Commit Messages & Changelog](#commit-messages--changelog).
